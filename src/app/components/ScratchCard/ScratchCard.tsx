    ...
    <div className="relative">
      ...
      >
        ...
        <ScratchCardCover
          ...
          color={"#55FFA3"}
        />
        <g mask="url(#myMask)">{!cardOpened && <HiddenCard />}</g>
...
const Confetti = () => {
  return (
    <div className="absolute">
      <div className="absolute top-0 -translate-x-64 -translate-y-96 -rotate-90">
        <SquigglyConfetti
          color={"#55FFA3"}
          transition={{ delay: 0.1, duration: 1 }}
        />
      </div>
      <div className="absolute top-0 translate-x-40 -translate-y-28">
        <SquigglyConfetti color={"#55FFA3"} transition={{ delay: 0.2 }} />
      </div>
      <div className="absolute top-0 translate-x-80 rotate-12  -translate-y-96">
        <SquigglyConfetti color={"#55FFA3"} transition={{ delay: 0.4 }} />
      </div>
    </div>
  );
};
